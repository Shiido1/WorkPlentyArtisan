...
class AuthorizationContractImpl implements AuthorizationContract {
  ...
  @override
  Future<Either<Failure, DefaultResponse>> forgotPassword(
      ForgotPasswordEntity entity) async {
    try {
      final _response = await authorizationSources!.fogotPassword(entity);
  ...
  @override
  Future<Either<Failure, DefaultResponse>> resetPassword(
      ResetPasswordEntity entity) async {
    try {
      final _response = await authorizationSources!.resetPassword(entity);
      return Right(_response);
    } catch (e) {
      return Left(AppFailure(e.toString()));
    }
